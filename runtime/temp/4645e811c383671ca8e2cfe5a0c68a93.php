<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:93:"/Users/lsiten/project/workman/chat-tp5/public/../application/admin/view/banner/adddetail.html";i:1512210886;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="commentForm" method="post" action="<?php echo url('banner/addDetail'); ?>" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-6">
                                <input class="form-control" type="text" placeholder="请填写带协议头(http://)的完整url地址 提示：可不填"  name="url" id="url" required="" aria-required="true"/>
                            </div>
                        </div>
                        <div class="form-group">
