<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:90:"/Users/lsiten/project/workman/chat-tp5/public/../application/admin/view/shop/cateedit.html";i:1513063197;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="commentForm" method="post" action="<?php echo url('shop/cateedit'); ?>" enctype="multipart/form-data">
                        <div class="form-group">
                                ...
                                <div class="col-sm-4 input-group">
                                    <select class="form-control" name="pid">
                                        ...
                                        <?php if(is_array($cate) || $cate instanceof \think\Collection): $i = 0; $__LIST__ = $cate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                            <option value="<?php echo $vo['id']; ?>" <?php if($vo['id'] == $item['pid']): ?>selected<?php endif; ?>><?php echo $vo['name']; ?></option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group col-sm-6">
                                    <input class="form-control" required="" aria-required="true" placeholder="必填" value="<?php echo $item['name']; ?>" type="text" name="name" id="name"/>
                                </div>
                            </div>
                             <div class="form-group">
                                <label class="col-sm-3 control-label">排名：</label>
                                <div class="input-group col-sm-6">
                                    <input class="form-control"  value="<?php echo $item['rank']; ?>" type="text" name="rank" id="rank"/>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group adver">
                                ...
                                <div class="input-group col-sm-6">
                                    <textarea class="form-control"  name="summary" value="<?php echo $item['summary']; ?>" id="summary" cols="30" rows="5"></textarea>
                                </div>
                            </div>                    
