<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:85:"/Users/lsiten/project/workman/chat-tp5/public/../application/admin/view/vip/card.html";i:1513163878;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="ibox-content">
            <div class="row">
                            <div class="form-group pull-right">
                                <button class="btn btn-outline btn-primary addCard" type="button">新增卡券</button>
                                <button class="btn btn-outline btn-success sendCard" type="button">发送卡券</button>
                            </div>
                            <!--搜索框开始-->
