<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:90:"/Users/lsiten/project/workman/chat-tp5/public/../application/admin/view/shop/groupadd.html";i:1513066377;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="commentForm" method="post" action="<?php echo url('shop/groupadd'); ?>" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-6">
                                <input placeholder="多个商品用','分割" class="form-control" required="" aria-required="true" type="text" name="goods" id="goods"/>
                            </div>
                        </div>
                        <div class="form-group">
