<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:90:"/Users/lsiten/project/workman/chat-tp5/public/../application/admin/view/shop/labeladd.html";i:1513075687;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="commentForm" method="post" action="<?php echo url('shop/labeladd'); ?>">
