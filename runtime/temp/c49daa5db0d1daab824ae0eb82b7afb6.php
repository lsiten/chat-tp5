<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:90:"/Users/lsiten/project/workman/chat-tp5/public/../application/admin/view/comment/index.html";i:1512226958;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
             ...
             <form id='commentForm' role="form" method="post" class="form-inline">
                    <div class="content clearfix m-b">
                        <div class="form-group">
                            <label>关键字：</label>
                            <input type="text" placeholder="标题/用户名/手机号/内容" class="form-control" id="title" name="title">
            ...
            <div class="example-wrap">
                <div class="example">
                    <table id="cusTable" data-height="850">
                        ...
                        <th data-field="create_time">留言时间</th>
