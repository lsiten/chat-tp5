<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"/Users/lsiten/project/workman/chat-tp5/public/../application/admin/view/login.html";i:1512125479;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<div class="signinpanel">
    <div class="row">
        <div class="col-sm-7">
            <div class="signin-info">
                ...
                <div class="m-b"></div>
                <h4>欢迎使用 <strong>lsiten</strong></h4>
                <ul class="m-b">
        ...
        <div class="col-sm-5">
            <form method="post" action="index.html">
                <p class="m-t-md" id="err_msg">登录到lsiten</p>
    ...
    <div class="signup-footer">
        <div class="pull-left">
            &copy; 2017 All Rights Reserved. Lsiten
        </div>
    </div>
</div>
