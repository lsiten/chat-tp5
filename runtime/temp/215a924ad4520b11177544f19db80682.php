<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:94:"/Users/lsiten/project/workman/chat-tp5/public/../application/admin/view/wx/qrcodebgempset.html";i:1513333483;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>员工二维码背景设置</title>
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="commentForm" method="post" action="<?php echo url('wx/qrcodeBgEmpSet'); ?>" enctype="multipart/form-data">       
