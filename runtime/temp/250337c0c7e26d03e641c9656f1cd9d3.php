<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:87:"/Users/lsiten/project/workman/chat-tp5/public/../application/admin/view/data/index.html";i:1512126833;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                    <?php if(!empty($tables)): if(is_array($tables) || $tables instanceof \think\Collection): if( count($tables)==0 ) : echo "" ;else: foreach($tables as $key=>$vo): ?>
                        <tr>
                            <td><?php echo $vo['Tables_in_laychat']; ?></td>
