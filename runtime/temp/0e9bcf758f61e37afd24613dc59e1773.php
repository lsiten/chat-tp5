<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:91:"/Users/lsiten/project/workman/chat-tp5/public/../application/admin/view/shop/goodsedit.html";i:1513096421;s:90:"/Users/lsiten/project/workman/chat-tp5/public/../application/admin/view/public/editor.html";i:1512216083;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <style>
        ...
        #previewEdit,#previewEdit2,#previewEdit3{
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="commentForm" method="post" action="<?php echo url('shop/goodsedit'); ?>" enctype="multipart/form-data">
                            ...
                            <div class="col-sm-4 input-group">
                                <select class="form-control" name="cid">
                                    ...
                                    <?php if(is_array($cate) || $cate instanceof \think\Collection): $i = 0; $__LIST__ = $cate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                        <option <?php if($vo['id'] == $item['cid']): ?>selected<?php endif; ?> value="<?php echo $vo['id']; ?>"><?php echo $vo['name']; ?></option>
                                        <?php if(isset($vo['_child'])): if(is_array($vo['_child']) || $vo['_child'] instanceof \think\Collection): $i = 0; $__LIST__ = $vo['_child'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo2): $mod = ($i % 2 );++$i;?>
                                                <option value="<?php echo $vo2['id']; ?>" <?php if($vo2['id'] == $item['cid']): ?>selected<?php endif; ?> >&nbsp;&nbsp;└<?php echo $vo2['name']; ?></option>
                                                <?php if(isset($vo2['_child'])): if(is_array($vo2['_child']) || $vo2['_child'] instanceof \think\Collection): if( count($vo2['_child'])==0 ) : echo "" ;else: foreach($vo2['_child'] as $key=>$vo3): ?>
                                                        <option value="<?php echo $vo3['id']; ?>" <?php if($vo3['id'] == $item['cid']): ?>selected<?php endif; ?> >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└<?php echo $vo3['name']; ?></option>
                                                        <?php if(isset($vo3['_child'])): if(is_array($vo3['_child']) || $vo3['_child'] instanceof \think\Collection): if( count($vo3['_child'])==0 ) : echo "" ;else: foreach($vo3['_child'] as $key=>$vo4): ?>
                                                                <option value="<?php echo $vo4['id']; ?>" <?php if($vo4['id'] == $item['cid']): ?>selected<?php endif; ?> >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└<?php echo $vo4['name']; ?></option>
                                                                <?php if(isset($vo4['_child'])): if(is_array($vo4['_child']) || $vo4['_child'] instanceof \think\Collection): if( count($vo4['_child'])==0 ) : echo "" ;else: foreach($vo4['_child'] as $key=>$vo5): ?>
                                                                        <option <?php if($vo5['id'] == $item['cid']): ?>selected<?php endif; ?> value="<?php echo $vo5['id']; ?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└<?php echo $vo5['name']; ?></option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-6">
                                <input class="form-control" required="" aria-required="true" placeholder="必填" type="text" value="<?php echo $item['name']; ?>"  name="name" id="name"/>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-6">
                                <div class="col-sm-6">
                                    <a class="inputButton <?php if($item["indexpic"]): ?>hidebuton<?php endif; ?>" id="imgInput">
                                        <input type="file" class="upload-input" name="indexpic" id="indexpic" onchange="previewFile()"/>
                                    </a>
                                    <?php if($item["indexpic"]): ?>
                                        <img src="<?php echo $item['indexpic']; ?>" id="previewEdit" alt="图片预览" onclick="changeImg()">
                                    <?php endif; ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-6">
                                <div class="col-sm-6">
                                        <a class="inputButton <?php if($item["listpic"]): ?>hidebuton<?php endif; ?>" id="imgInput2">
                                            <input type="file" class="upload-input" name="listpic" id="listpic" onchange="previewFile2()"/>
                                        </a>
                                        <?php if($item["listpic"]): ?>
                                            <img src="<?php echo $item['listpic']; ?>" id="previewEdit2" alt="图片预览" onclick="changeImg2()">
                                        <?php endif; ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-6">
                                <div class="col-sm-6">
                                        <a class="inputButton <?php if($item["pic"]): ?>hidebuton<?php endif; ?>" id="imgInput3">
                                            <input type="file" class="upload-input" name="pic" id="pic" onchange="previewFile3()"/>
                                        </a>
                                        <?php if($item["pic"]): ?>
                                            <img src="<?php echo $item['pic']; ?>" id="previewEdit3" alt="图片预览" onclick="changeImg3()">
                                        <?php endif; ?>
                         ...
                         <div class="form-group">
                            ...
                            <div class="input-group col-sm-6">
                                    <div class="input-group">
                                        <input type="text" class="form-control" value="<?php echo $item['album']; ?>" name="album" id="App-album">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-6">
                                <input class="form-control" required="" aria-required="true" placeholder="必填" type="text" value="<?php echo $item['unit']; ?>" name="unit" id="unit"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">商品价格：</label>
                            <div class="input-group col-sm-6">
                                <input class="form-control" required="" aria-required="true" placeholder="必填" type="text" value="<?php echo $item['price']; ?>" name="price" id="price"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">商品原价：</label>
                            <div class="input-group col-sm-6">
                                <input class="form-control" required="" aria-required="true" placeholder="必填" type="text" value="<?php echo $item['oprice']; ?>" name="oprice" id="oprice"/>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-6"></div>
                                <div class="col-sm-2">
                                    <div class="input-group input-group-xs">
                                        ...
                                        <input name="fx1rate" value="<?php echo $item['fx1rate']; ?>"  type="text" class="form-control">
                                    </div>
                                </div>
                                <div class="col-sm-2">
                                    <div class="input-group input-group-xs">
                                        ...
                                        <input name="fx2rate" value="<?php echo $item['fx2rate']; ?>" type="text" class="form-control">
                                    </div>
                                </div>
                                <div class="col-sm-2">
                                    <div class="input-group input-group-xs">
                                        ...
                                        <input name="fx3rate" value="<?php echo $item['fx3rate']; ?>" type="text" class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="input-group col-sm-6">
                                    <input class="form-control" required="" aria-required="true" placeholder="必填" type="text" value="<?php echo $item['num']; ?>" name="num" id="num"/>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="input-group col-sm-6">
                                    <label>
                                        <input type="hidden" name="issku" value="<?php echo $item['issku']; ?>"  id="issku">
                                        <input class="checkbox-slider slider-icon colored-darkorange" type="checkbox" <?php if($item['issku'] == '1'): ?>checked="checked"<?php endif; ?> id="isskubtn">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group col-sm-6">
                                    <label>
                                        <input type="hidden" value="<?php echo $item['ismy']; ?>" name="ismy"  id="ismy">
                                        <input <?php if($item['ismy'] == '1'): ?>checked="checked"<?php endif; ?> class="checkbox-slider slider-icon colored-darkorange" type="checkbox" id="ismybtn">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group col-sm-6">
                                    <label>
                                        <input type="hidden" value="<?php echo $item['issells']; ?>" name="issells"  id="issells">
                                        <input class="checkbox-slider slider-icon colored-darkorange" <?php if($item['issells'] == '1'): ?>checked="checked"<?php endif; ?> type="checkbox" id="issellsbtn">
                            ...
                            <div class="form-group" id="dissells">
                                ...
                                <div class="input-group col-sm-6">
                                    <input type="text" class="form-control" value="<?php echo $item['dissells']; ?>" name="dissells" placeholder="填写自定义销量，此销量也会自动增长">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="input-group col-sm-6">
                                    <label>
                                        <input type="hidden" name="cashback"  value="<?php echo $item['cashback']; ?>" id="cashback">
                                        <input class="checkbox-slider slider-icon colored-darkorange" <?php if($item['cashback'] == '1'): ?>checked="checked"<?php endif; ?> type="checkbox" id="cashbackbtn">
                            ...
                            <div class="form-group" id="backratio">
                                ...
                                <div class="input-group col-sm-6">
                                    <input type="text" class="form-control" value="<?php echo $item['backratio']; ?>" name="backratio" placeholder="例如0.01">
                                </div>
                            </div> 
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group col-sm-6">
                                    <?php if(is_array($label) || $label instanceof \think\Collection): $i = 0; $__LIST__ = $label;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo_l): $mod = ($i % 2 );++$i;?>
                                        <label>
                                            <input type="checkbox" class="colored-blue label-check" <?php if(in_array(($vo_l['id']), is_array($item['lid'])?$item['lid']:explode(',',$item['lid']))): ?>checked="checked"<?php endif; ?> value="<?php echo $vo_l['id']; ?>" data-label="<?php echo $vo_l['name']; ?>">
                                            <span class="text"><?php echo $vo_l['name']; ?>&nbsp;&nbsp;&nbsp;&nbsp;</span>
                                        </label>
                                    <?php endforeach; endif; else: echo "" ;endif; ?>
                                </div>
                                <input type="hidden" value="<?php echo $item['lid']; ?>"  name="lid" id="lid" />
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">商品备注</label>
                                <div class="input-group col-sm-6">
                                    <textarea class="form-control" name="summary" rows="5"><?php echo $item['summary']; ?></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">商品排序</label>
                                <div class="input-group col-sm-6">
                                    <input type="text" class="form-control" value="<?php echo $item['sorts']; ?>" name="sorts" placeholder="必填" required="" aria-required="true">
                                </div>
                            </div>
                            <div class="form-group">
