<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:88:"/Users/lsiten/project/workman/chat-tp5/public/../application/admin/view/shop/adsadd.html";i:1513047424;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="commentForm" method="post" action="<?php echo url('shop/adsadd'); ?>" enctype="multipart/form-data">
                        <div class="form-group">
                            <label class="col-sm-3 control-label">广告名称：</label>
                            <div class="col-sm-4 input-group">
                                <input class="form-control" placeholder="必填，全局唯一" type="text" name="name" id="name" required="" aria-required="true"/>                                
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-6">
                                <div class="col-sm-6">
                                    <a class="inputButton" id="imgInput">
                                        <input required="" aria-required="true" type="file" class="upload-input" name="pic" id="pic" onchange="previewFile()"/>
                                    </a>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-6">
                                <input class="form-control" required="" aria-required="true" placeholder="#" type="text" name="url" id="url"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group adver">
                            ...
                            <div class="input-group col-sm-6">
                                <input class="form-control" placeholder="选填" type="text" name="mark" id="mark"/>
                            </div>
                        </div>                     
