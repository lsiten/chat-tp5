<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:88:"/Users/lsiten/project/workman/chat-tp5/public/../application/admin/view/product/add.html";i:1512282475;s:90:"/Users/lsiten/project/workman/chat-tp5/public/../application/admin/view/public/editor.html";i:1512216083;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="commentForm" method="post" action="<?php echo url('product/add'); ?>" enctype="multipart/form-data" >
                        ...
                        <div class="form-group">
                                ...
                                <div class="input-group col-sm-6">
                                    <input class="form-control" type="text" name="brand" id="brand" required="" aria-required="true"/>
                                </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">产品单位：</label>
                            <div class="input-group col-sm-6">
                                <input class="form-control" placeholder="例：kg，个" type="text" name="units" id="units" required="" aria-required="true"/>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-6">
                                <input class="form-control" placeholder="0.00" type="text" name="price" id="price" required="" aria-required="true"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-6">
                                <input class="form-control" placeholder="0.00" type="text" name="marketprice" id="marketprice" required="" aria-required="true"/>
                                <span style="color:red;">*单位：元</span>
                            </div>
                        </div>
                        <div class="form-group">
