<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:93:"/Users/lsiten/project/workman/chat-tp5/public/../application/admin/view/shop/skuattredit.html";i:1513071577;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="commentForm" method="post" action="<?php echo url('shop/skuattredit'); ?>">
                        <div class="form-group">
                            <label class="col-sm-3 control-label">属性名称：</label>
                            <div class="col-sm-4 input-group">
                                <input class="form-control" placeholder="必填" value="<?php echo $item['name']; ?>" type="text" name="name" id="name" required="" aria-required="true"/>                                
                            </div>
                        </div>
                        ...
                        <div class="form-group adver">
                            ...
                            <div class="input-group col-sm-6">
                                <textarea disabled class="form-control"  name="items" id="items" cols="30" rows="5"><?php echo $item['items']; ?></textarea>
                            </div>
                        </div>                     
