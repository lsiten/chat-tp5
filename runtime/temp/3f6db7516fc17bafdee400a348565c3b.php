<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:91:"/Users/lsiten/project/workman/chat-tp5/public/../application/admin/view/wx/keywordedit.html";i:1512974038;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="commentForm" method="post" action="<?php echo url('wx/keywordedit'); ?>" enctype="multipart/form-data">
                        <div class="form-group">
                            <label class="col-sm-3 control-label">触发关键词：</label>
                            <div class="col-sm-4 input-group">
                                <input class="form-control" value="<?php echo $item['keyword']; ?>"  placeholder="必填，全局唯一" type="text" name="keyword" id="keyword" required="" aria-required="true"/>                                
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4 input-group">
                                <select name="type" class="form-control" required="" aria-required="true">
                                    <option <?php if($item["type"] == 1): ?>selected<?php endif; ?>  value="1" title="纯文本">纯文本</option>
                                    <option <?php if($item["type"] == 2): ?>selected<?php endif; ?> value="2" title="单图文">单图文</option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-6">
                                <input class="form-control" value="<?php echo $item['name']; ?>" placeholder="选填" type="text" name="name" id="name"/>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-6">
                                <div class="col-sm-6">
                                    <a class="inputButton <?php if($item["pic"]): ?>hidebuton<?php endif; ?>" id="imgInput">
                                        <input type="file" class="upload-input" name="pic" id="pic" onchange="previewFile()"/>
                                    </a>
                                    <?php if($item["pic"]): ?>
                                        <img src="<?php echo $item['pic']; ?>" id="previewEdit" alt="图片预览" onclick="changeImg()">
                                    <?php endif; ?>
                        ...
                        <div class="form-group adver">
                            ...
                            <div class="input-group col-sm-6">
                                <input class="form-control" value="<?php echo $item['url']; ?>" placeholder="选填" type="text" name="url" id="url"/>
                            </div>
                        </div>
                        <div class="form-group">
