<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:92:"/Users/lsiten/project/workman/chat-tp5/public/../application/admin/view/layuser/useradd.html";i:1511242424;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="commentForm" method="post" action="<?php echo url('layuser/useradd'); ?>" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4 input-group">
                                <select name="groupid" class="form-control" required="" aria-required="true">
                                    ...
                                    <?php if(is_array($group) || $group instanceof \think\Collection): if( count($group)==0 ) : echo "" ;else: foreach($group as $key=>$vo): ?>
