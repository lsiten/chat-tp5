<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:94:"/Users/lsiten/project/workman/chat-tp5/public/../application/admin/view/banner/editdetail.html";i:1512212239;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="commentForm" method="post" action="<?php echo url('banner/editDetail'); ?>" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-6">
                                <div class="col-sm-6">
                                    <a class="inputButton <?php if($item["img"]): ?>hidebuton<?php endif; ?>" id="imgInput">
                                        <input type="file" class="upload-input" name="img" id="img" required="" aria-required="true" onchange="previewFile()"/>
                                    </a>
                                    <?php if($item["img"]): ?>
                                        <img src="<?php echo $item['img']; ?>" id="previewEdit" alt="图片预览" onclick="changeImg()">
                                    <?php endif; ?>
